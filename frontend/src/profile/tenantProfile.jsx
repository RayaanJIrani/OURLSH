  ...
  return (
    <div className="container my-5 bg-white border border-light border-2">
      ...
      {(() => {
            ...
            return (
              <img src={tenant[0].profile_pic} className="my-4 rounded mx-auto d-block"/>
            );
      }})()}
      <div className="my-4 row justify-content-center">
        <div className="col-4 my-3">
          ...
          <div>
            ...
            <h5 className="my-2">Last Name: <span className="text-muted">{tenant[0].last_name}</span></h5>
            <h5 className="my-2">First Name: <span className="text-muted">{tenant[0].first_name}</span></h5>
            <h5 className="my-2">Email: <span className="text-muted">{tenant[0].email}</span></h5>
          </div>
        </div>
        <div className="col-3 my-3">
          ...
          <div className="my-3">
            <button type="button" className="btn btn-primary" onClick={handleWorkorder}>
              Create Workorder
            </button>
          </div>
          <div className="my-3">
